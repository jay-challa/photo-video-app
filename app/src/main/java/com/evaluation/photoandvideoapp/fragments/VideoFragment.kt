...
import com.evaluation.photoandvideoapp.adapter.VideoAdapter
...
import com.evaluation.photoandvideoapp.video.VideoActivity
import com.evaluation.photoandvideoapp.viewmodel.DashboardViewModel

private const val ARG_PARAM1 = "param1"
private const val ARG_PARAM2 = "param2"

class VideoFragment : Fragment(), ItemClick {
	
	private var param1 : String? = null
	private var param2 : String? = null
	
	
	var videoAdapter = VideoAdapter(this)
	...
	override fun onCreateView(
		...
		dashboardViewModel.getVideoList()
		dashboardViewModel.getVideoLiveData().observe(viewLifecycleOwner, Observer {
			videoAdapter.setItems(it.videos)
