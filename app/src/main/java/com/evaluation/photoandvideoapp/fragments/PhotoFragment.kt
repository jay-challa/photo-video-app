...
import com.evaluation.photoandvideoapp.adapter.PhotoAdapter
...
class PhotoFragment : Fragment(), ItemClick {
	...
	override fun onCreateView(
		...
		dashboardViewModel.getPhotoList()
		dashboardViewModel.getPhotoReponses().observe(viewLifecycleOwner, Observer {
			photoAdapter.setItems(it.photos!!)
